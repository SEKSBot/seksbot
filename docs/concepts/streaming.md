...
seksbot has two separate “streaming” layers:
...
When block streaming is enabled, seksbot can **merge consecutive block chunks**
...
When draft streaming is active, seksbot disables block streaming for that reply to avoid double-streaming.
