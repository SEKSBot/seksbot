...
- Same path: run the app from a fixed location (for seksbot, `dist/seksbot.app`).
...
Workaround: move files into the seksbot workspace (`~/.seksbot/workspace`) if you want to avoid per-folder grants.
