---
summary: "First-run onboarding flow for seksbot (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give seksbot">
...
<Step title="CLI">
  ...
  The app can install the global `seksbot` CLI via npm/pnpm so terminal
