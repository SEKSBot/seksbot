---
summary: "Use Qianfan's unified API to access many models in seksbot"
read_when:
...
3. seksbot installed on your system
...
4. Copy the API key for use with seksbot

## CLI setup

```bash
seksbot onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [seksbot Configuration](/gateway/configuration)
