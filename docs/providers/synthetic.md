---
summary: "Use Synthetic's Anthropic-compatible API in seksbot"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. seksbot registers it as the
...
Note: seksbot's Anthropic client appends `/v1` to the base URL, so use
