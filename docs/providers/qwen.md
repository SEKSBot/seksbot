---
summary: "Use Qwen OAuth (free tier) in seksbot"
read_when:
  - You want to use Qwen with seksbot
...
If you already logged in with the Qwen Code CLI, seksbot will sync credentials
