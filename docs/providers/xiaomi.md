---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with seksbot"
read_when:
  - You want Xiaomi MiMo models in seksbot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). seksbot uses
