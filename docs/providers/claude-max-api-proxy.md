...
You can point seksbot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or seksbot
...
- [Anthropic provider](/providers/anthropic) - Native seksbot integration with Claude setup-token or API keys
