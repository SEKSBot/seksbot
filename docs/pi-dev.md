...
This guide summarizes a sane workflow for working on the pi integration in seksbot.
...
- Trigger the agent directly:
  - `pnpm seksbot agent --message "Hello" --thinking low`
...
State lives under the seksbot state directory. Default is `~/.seksbot`. If `SEKSBOT_STATE_DIR` is set, use that directory instead.

To reset everything:

- `seksbot.json` for config
...
- [https://docs.seksbot.ai/testing](https://docs.seksbot.ai/testing)
- [https://docs.seksbot.ai/start/getting-started](https://docs.seksbot.ai/start/getting-started)
