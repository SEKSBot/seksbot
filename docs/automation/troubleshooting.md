...
seksbot system heartbeat last
seksbot logs --follow
seksbot config get agents.defaults.heartbeat
seksbot channels status --probe
```
...
```bash
seksbot config get agents.defaults.heartbeat.activeHours
seksbot config get agents.defaults.heartbeat.activeHours.timezone
seksbot config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
seksbot cron list
seksbot logs --follow
```
