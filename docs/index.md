---
summary: "seksbot is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing seksbot to newcomers
title: "seksbot"
---
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install seksbot and bring up the Gateway in minutes.
  </Card>
  <Card title="Run the Wizard" href="/start/wizard" icon="sparkles">
    Guided setup with `seksbot onboard` and pairing flows.
  </Card>
...
Config lives at `~/.seksbot/seksbot.json`.

- If you **do nothing**, seksbot uses the bundled Pi binary in RPC mode with per-sender sessions.
