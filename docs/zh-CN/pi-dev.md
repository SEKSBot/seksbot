...
本指南总结了在 seksbot 中开发 Pi 集成的合理工作流程。
...
状态存储在 seksbot 状态目录下。默认为 `~/.seksbot`。如果设置了 `SEKSBOT_STATE_DIR`，则使用该目录。
...
- https://docs.seksbot.ai/testing
- https://docs.seksbot.ai/start/getting-started
