...
read_when:
  - You are building a seksbot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (seksbot.plugin.json)

Every plugin **must** ship a `seksbot.plugin.json` file in the **plugin root**.
seksbot uses this manifest to validate configuration **without executing plugin
