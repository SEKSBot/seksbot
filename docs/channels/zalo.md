...
- Install via CLI: `seksbot plugins install @seksbot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `seksbot plugins install ./extensions/zalo`
   - From npm (if published): `seksbot plugins install @seksbot/zalo`
...
- Approve via:
  - `seksbot pairing list zalo`
  - `seksbot pairing approve zalo <CODE>`
...
- Example: `seksbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `seksbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `seksbot logs --follow`
