...
import type { seksbotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: seksbotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: seksbotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: seksbotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: seksbotConfig) => void;
  log: {
