...
import { type seksbotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: seksbotConfig): string[] {
...
export function listAgentsForGateway(cfg: seksbotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: seksbotConfig): string {
...
function resolveSessionStoreAgentId(cfg: seksbotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: seksbotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: seksbotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: seksbotConfig): GatewaySessionsDefaults {
