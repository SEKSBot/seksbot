...
export function resolveHooksConfig(cfg: seksbotConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: seksbotConfig, defaultAgentId: string): Set<string> {
