...
export const A2UI_PATH = "/__seksbot__/a2ui";

export const CANVAS_HOST_PATH = "/__seksbot__/canvas";

export const CANVAS_WS_PATH = "/__seksbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.seksbotCanvasA2UIAction.postMessage(...)
  // - Android: window.seksbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["seksbotCanvasA2UIAction"];
  ...
  globalThis.seksbot = globalThis.seksbot ?? {};
  globalThis.seksbot.postMessage = postToNode;
  globalThis.seksbot.sendUserAction = sendUserAction;
  globalThis.seksbotPostMessage = postToNode;
  globalThis.seksbotSendUserAction = sendUserAction;
