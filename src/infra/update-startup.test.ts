...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "seksbot-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveseksbotPackageRoot } = await import("./seksbot-root.js");
    ...
    vi.mocked(resolveseksbotPackageRoot).mockResolvedValue("/opt/seksbot");
