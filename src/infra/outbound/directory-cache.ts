...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: seksbotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: seksbotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: seksbotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: seksbotConfig): void {
