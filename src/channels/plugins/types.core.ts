...
export type ChannelAgentToolFactory = (params: { cfg?: seksbotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: seksbotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: seksbotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: seksbotConfig }) => boolean;
  supportsCards?: (params: { cfg: seksbotConfig }) => boolean;
