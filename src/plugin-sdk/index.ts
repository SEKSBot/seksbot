...
export type { seksbotConfig } from "../config/config.js";
/** @deprecated Use seksbotConfig instead */
export type { seksbotConfig as ClawdbotConfig } from "../config/config.js";
