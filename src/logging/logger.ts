...
export const DEFAULT_LOG_DIR = "/tmp/seksbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "seksbot.log"); // legacy single-file path

const LOG_PREFIX = "seksbot";
