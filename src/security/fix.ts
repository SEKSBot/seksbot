...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof seksbotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: seksbotConfig; env: NodeJS.ProcessEnv }): {
  cfg: seksbotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
