...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @seksbot/voice-call -> voice-call).
...
export function discoverseksbotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".seksbot", "extensions")];
