...
export function listSlackAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: seksbotConfig): string {
...
function mergeSlackAccountConfig(cfg: seksbotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: seksbotConfig): ResolvedSlackAccount[] {
