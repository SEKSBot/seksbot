...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.seksbot.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("seksbot hooks list")}`,
      `  ${formatCliCommand("seksbot hooks enable <name>")}`,
      `  ${formatCliCommand("seksbot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
