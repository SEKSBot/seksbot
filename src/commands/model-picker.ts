...
function resolveConfiguredModelRaw(cfg: seksbotConfig): string {
...
function resolveConfiguredModelKeys(cfg: seksbotConfig): string[] {
...
export function applyPrimaryModel(cfg: seksbotConfig, model: string): seksbotConfig {
...
export function applyModelAllowlist(cfg: seksbotConfig, models: string[]): seksbotConfig {
  const defaults = cfg.agents?.defaults;
