...
export function applyZaiConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyOpenrouterProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyOpenrouterConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyLitellmProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyMoonshotProviderConfig(cfg: seksbotConfig): seksbotConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: seksbotConfig): seksbotConfig {
...
export function applyMoonshotConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyMoonshotConfigCn(cfg: seksbotConfig): seksbotConfig {
...
export function applyKimiCodeProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applySyntheticProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyXiaomiProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: seksbotConfig): seksbotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: seksbotConfig): seksbotConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyXaiProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: seksbotConfig): seksbotConfig {
...
export function applyQianfanProviderConfig(cfg: seksbotConfig): seksbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: seksbotConfig): seksbotConfig {
