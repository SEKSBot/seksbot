...
function resolveDefaultAccountId(cfg: seksbotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: seksbotConfig): boolean {
...
export function summarizeBindings(cfg: seksbotConfig, bindings: AgentBinding[]): string[] {
