...
const ensureseksbotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveseksbotAgentDir = vi.fn().mockReturnValue("/tmp/seksbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/seksbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureseksbotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveseksbotAgentDir,
}));
