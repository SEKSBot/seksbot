...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "seksbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<seksbotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<seksbotConfig["telegram"]>>,
