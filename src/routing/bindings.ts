...
export function listBindings(cfg: seksbotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: seksbotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: seksbotConfig) {
