...
export function listSignalAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: seksbotConfig): string {
...
function mergeSignalAccountConfig(cfg: seksbotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: seksbotConfig): ResolvedSignalAccount[] {
