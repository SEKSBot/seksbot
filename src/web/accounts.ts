...
function listConfiguredAccountIds(cfg: seksbotConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: seksbotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: seksbotConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: seksbotConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: seksbotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: seksbotConfig): ResolvedWhatsAppAccount[] {
