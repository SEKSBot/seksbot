...
import type { seksbotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: seksbotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: seksbotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
