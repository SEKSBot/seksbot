...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.SEKSBOT_STATE_DIR;
  const configPath = env.SEKSBOT_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    SEKSBOT_PROFILE: profile,
    SEKSBOT_STATE_DIR: stateDir,
    SEKSBOT_CONFIG_PATH: configPath,
    SEKSBOT_GATEWAY_PORT: String(port),
    SEKSBOT_GATEWAY_TOKEN: token,
    SEKSBOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SEKSBOT_SYSTEMD_UNIT: systemdUnit,
    SEKSBOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SEKSBOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SEKSBOT_STATE_DIR: stateDir,
    SEKSBOT_CONFIG_PATH: configPath,
    SEKSBOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SEKSBOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SEKSBOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SEKSBOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SEKSBOT_LOG_PREFIX: "node",
    SEKSBOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SEKSBOT_SERVICE_KIND: NODE_SERVICE_KIND,
    SEKSBOT_SERVICE_VERSION: VERSION,
  };
}
