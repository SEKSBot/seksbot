import type { seksbotConfig } from "./config.js";
...
function isTelegramConfigured(cfg: seksbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: seksbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: seksbotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: seksbotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: seksbotConfig): boolean {
...
function isIMessageConfigured(cfg: seksbotConfig): boolean {
...
function isWhatsAppConfigured(cfg: seksbotConfig): boolean {
...
function isGenericChannelConfigured(cfg: seksbotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: seksbotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: seksbotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: seksbotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: seksbotConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: seksbotConfig, pluginId: string): seksbotConfig {
...
function registerPluginEntry(cfg: seksbotConfig, pluginId: string): seksbotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
