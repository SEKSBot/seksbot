...
function resolveAnthropicDefaultAuthMode(cfg: seksbotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: seksbotConfig): seksbotConfig {
...
export function applyTalkApiKey(config: seksbotConfig): seksbotConfig {
...
export function applyModelDefaults(cfg: seksbotConfig): seksbotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: seksbotConfig): seksbotConfig {
...
export function applyLoggingDefaults(cfg: seksbotConfig): seksbotConfig {
...
export function applyContextPruningDefaults(cfg: seksbotConfig): seksbotConfig {
...
export function applyCompactionDefaults(cfg: seksbotConfig): seksbotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
