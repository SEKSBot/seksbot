...
function resolveMentionPatterns(cfg: seksbotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: seksbotConfig | undefined, agentId?: string): RegExp[] {
