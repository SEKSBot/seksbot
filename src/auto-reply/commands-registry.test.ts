...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@seksbot", { botUsername: "seksbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@seksbot args", {
        botUsername: "seksbot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "seksbot" })).toBe(
      "/help@otherbot",
    );
  });
