...
// pi-ai's built-in Anthropic catalog can lag behind seksbot's defaults/docs.
...
export function buildModelAliasLines(cfg?: seksbotConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveseksbotAgentDir();
