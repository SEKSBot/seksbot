...
describe("createseksbotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createseksbotCodingTools({
      config,
    ...
    const anthropicTools = createseksbotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createseksbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createseksbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
