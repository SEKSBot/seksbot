...
function resolveAvatarSource(cfg: seksbotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: seksbotConfig, agentId: string): AgentAvatarResolution {
