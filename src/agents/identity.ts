import type { seksbotConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: seksbotConfig, agentId: string): string {
...
export function resolveIdentityNamePrefix(cfg: seksbotConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: seksbotConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[seksbot]";
}
