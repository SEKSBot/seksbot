...
function resolveWatchPaths(workspaceDir: string, config?: seksbotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: seksbotConfig }) {
