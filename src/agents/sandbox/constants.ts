...
export const DEFAULT_SANDBOX_IMAGE = "seksbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "seksbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "seksbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "seksbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "seksbot-sbx-browser-";
