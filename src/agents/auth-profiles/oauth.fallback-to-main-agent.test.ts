...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveseksbotAgentDir() returns mainAgentDir
    process.env.SEKSBOT_STATE_DIR = tmpDir;
    process.env.SEKSBOT_AGENT_DIR = mainAgentDir;
