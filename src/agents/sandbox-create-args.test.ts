  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "seksbot.sandbox=1",
        "--label",
        "seksbot.sessionKey=main",
        "--label",
        "seksbot.createdAtMs=1700000000000",
        "--label",
        "seksbot.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
