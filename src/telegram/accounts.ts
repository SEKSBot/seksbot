...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SEKSBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: seksbotConfig): string {
...
function mergeTelegramAccountConfig(cfg: seksbotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: seksbotConfig): ResolvedTelegramAccount[] {
