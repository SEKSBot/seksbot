...
export function listZalouserAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: seksbotConfig): string {
...
function mergeZalouserAccountConfig(cfg: seksbotConfig, accountId: string): ZalouserAccountConfig {
