...
export function listGoogleChatAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: seksbotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: seksbotConfig): ResolvedGoogleChatAccount[] {
