...
import { DEFAULT_ACCOUNT_ID, isTruthyEnvValue, normalizeAccountId } from "seksbot/plugin-sdk";
import type { CoreConfig, NextcloudTalkAccountConfig } from "./types.js";

const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SEKSBOT_DEBUG_NEXTCLOUD_TALK_ACCOUNTS)) {
