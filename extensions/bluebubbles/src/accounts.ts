...
export function listBlueBubblesAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: seksbotConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: seksbotConfig): ResolvedBlueBubblesAccount[] {
