...
export function listMattermostAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: seksbotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: seksbotConfig): ResolvedMattermostAccount[] {
