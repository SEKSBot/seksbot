import type { ChannelOnboardingAdapter, seksbotConfig, WizardPrompter } from "seksbot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.seksbot.ai/channels/mattermost",
    ].join("\n"),
