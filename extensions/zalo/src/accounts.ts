import type { seksbotConfig } from "seksbot/plugin-sdk";
...
export function listZaloAccountIds(cfg: seksbotConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: seksbotConfig): string {
...
function mergeZaloAccountConfig(cfg: seksbotConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: seksbotConfig): ResolvedZaloAccount[] {
