...
import type { ReplyPayload, seksbotConfig } from "seksbot/plugin-sdk";
import { createReplyPrefixOptions } from "seksbot/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as seksbotConfig;
