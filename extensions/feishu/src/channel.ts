import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "seksbot/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "seksbot/plugin-sdk";
