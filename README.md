# 🦞 seksbot — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/seksbot/seksbot/main/docs/assets/seksbot-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/seksbot/seksbot/main/docs/assets/seksbot-logo-text.png" alt="seksbot" width="500">
    </picture>
</p>
...
**seksbot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://seksbot.ai) · [Docs](https://docs.seksbot.ai) · [DeepWiki](https://deepwiki.com/seksbot/seksbot) · [Getting Started](https://docs.seksbot.ai/start/getting-started) · [Updating](https://docs.seksbot.ai/install/updating) · [Showcase](https://docs.seksbot.ai/start/showcase) · [FAQ](https://docs.seksbot.ai/start/faq) · [Wizard](https://docs.seksbot.ai/start/wizard) · [Nix](https://github.com/seksbot/nix-seksbot) · [Docker](https://docs.seksbot.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`seksbot onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.seksbot.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.seksbot.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.seksbot.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.seksbot.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.seksbot.ai/start/getting-started)

```bash
seksbot onboard --install-daemon

seksbot gateway --port 18789 --verbose

# Send a message
seksbot message send --to +1234567890 --message "Hello from seksbot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
seksbot agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.seksbot.ai/install/updating) (and run `seksbot doctor`).
...
Switch channels (git + npm): `seksbot update --channel stable|beta|dev`.
Details: [Development channels](https://docs.seksbot.ai/install/development-channels).
...
Note: `pnpm seksbot ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `seksbot` binary.

## Security defaults (DM access)

seksbot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.seksbot.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `seksbot pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `seksbot doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.seksbot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.seksbot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.seksbot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.seksbot.ai/nodes/voicewake) + [Talk Mode](https://docs.seksbot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.seksbot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.seksbot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.seksbot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.seksbot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.seksbot.ai/nodes).
- **[Onboarding](https://docs.seksbot.ai/start/wizard) + [skills](https://docs.seksbot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=seksbot/seksbot&type=date&legend=top-left)](https://www.star-history.com/#seksbot/seksbot&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.seksbot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.seksbot.ai/web), and [Canvas host](https://docs.seksbot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.seksbot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.seksbot.ai/start/wizard), and [doctor](https://docs.seksbot.ai/gateway/doctor).
- [Pi agent runtime](https://docs.seksbot.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.seksbot.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.seksbot.ai/concepts/groups).
- [Media pipeline](https://docs.seksbot.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.seksbot.ai/nodes/audio).

### Channels

- [Channels](https://docs.seksbot.ai/channels): [WhatsApp](https://docs.seksbot.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.seksbot.ai/channels/telegram) (grammY), [Slack](https://docs.seksbot.ai/channels/slack) (Bolt), [Discord](https://docs.seksbot.ai/channels/discord) (discord.js), [Google Chat](https://docs.seksbot.ai/channels/googlechat) (Chat API), [Signal](https://docs.seksbot.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.seksbot.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.seksbot.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.seksbot.ai/channels/msteams) (extension), [Matrix](https://docs.seksbot.ai/channels/matrix) (extension), [Zalo](https://docs.seksbot.ai/channels/zalo) (extension), [Zalo Personal](https://docs.seksbot.ai/channels/zalouser) (extension), [WebChat](https://docs.seksbot.ai/web/webchat).
- [Group routing](https://docs.seksbot.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.seksbot.ai/channels).

### Apps + nodes

- [macOS app](https://docs.seksbot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.seksbot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.seksbot.ai/nodes/talk) overlay, [WebChat](https://docs.seksbot.ai/web/webchat), debug tools, [remote gateway](https://docs.seksbot.ai/gateway/remote) control.
- [iOS node](https://docs.seksbot.ai/platforms/ios): [Canvas](https://docs.seksbot.ai/platforms/mac/canvas), [Voice Wake](https://docs.seksbot.ai/nodes/voicewake), [Talk Mode](https://docs.seksbot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.seksbot.ai/platforms/android): [Canvas](https://docs.seksbot.ai/platforms/mac/canvas), [Talk Mode](https://docs.seksbot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.seksbot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.seksbot.ai/tools/browser): dedicated seksbot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.seksbot.ai/platforms/mac/canvas): [A2UI](https://docs.seksbot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.seksbot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.seksbot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.seksbot.ai/automation/cron-jobs); [webhooks](https://docs.seksbot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.seksbot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.seksbot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.seksbot.ai/concepts/channel-routing), [retry policy](https://docs.seksbot.ai/concepts/retry), and [streaming/chunking](https://docs.seksbot.ai/concepts/streaming).
- [Presence](https://docs.seksbot.ai/concepts/presence), [typing indicators](https://docs.seksbot.ai/concepts/typing-indicators), and [usage tracking](https://docs.seksbot.ai/concepts/usage-tracking).
- [Models](https://docs.seksbot.ai/concepts/models), [model failover](https://docs.seksbot.ai/concepts/model-failover), and [session pruning](https://docs.seksbot.ai/concepts/session-pruning).
- [Security](https://docs.seksbot.ai/gateway/security) and [troubleshooting](https://docs.seksbot.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.seksbot.ai/web) + [WebChat](https://docs.seksbot.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.seksbot.ai/gateway/tailscale) or [SSH tunnels](https://docs.seksbot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.seksbot.ai/install/nix) for declarative config; [Docker](https://docs.seksbot.ai/install/docker)-based installs.
- [Doctor](https://docs.seksbot.ai/gateway/doctor) migrations, [logging](https://docs.seksbot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.seksbot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.seksbot.ai/gateway)).
- **[Tailscale exposure](https://docs.seksbot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.seksbot.ai/gateway/remote)).
- **[Browser control](https://docs.seksbot.ai/tools/browser)** — seksbot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.seksbot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.seksbot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.seksbot.ai/nodes/voicewake) + [Talk Mode](https://docs.seksbot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.seksbot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

seksbot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (seksbot enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.seksbot.ai/gateway/tailscale) · [Web surfaces](https://docs.seksbot.ai/web)
...
Details: [Remote access](https://docs.seksbot.ai/gateway/remote) · [Nodes](https://docs.seksbot.ai/nodes) · [Security](https://docs.seksbot.ai/gateway/security)
...
Details: [Nodes](https://docs.seksbot.ai/nodes) · [macOS app](https://docs.seksbot.ai/platforms/macos) · [Gateway protocol](https://docs.seksbot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.seksbot.ai/concepts/session-tool)
...
- Controlled via `seksbot nodes …`.

Runbook: [iOS connect](https://docs.seksbot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.seksbot.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.seksbot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.seksbot/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.seksbot/seksbot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.seksbot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.seksbot.ai/gateway/security) · [Docker + sandboxing](https://docs.seksbot.ai/install/docker) · [Sandbox config](https://docs.seksbot.ai/gateway/configuration)

### [WhatsApp](https://docs.seksbot.ai/channels/whatsapp)

- Link the device: `pnpm seksbot channels login` (stores creds in `~/.seksbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.seksbot.ai/channels/telegram)
...
### [Slack](https://docs.seksbot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.seksbot.ai/channels/discord)
...
### [Signal](https://docs.seksbot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.seksbot.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.seksbot.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.seksbot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.seksbot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.seksbot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.seksbot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.seksbot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.seksbot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.seksbot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.seksbot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.seksbot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.seksbot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.seksbot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.seksbot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.seksbot.ai/platforms/windows), [Linux](https://docs.seksbot.ai/platforms/linux), [macOS](https://docs.seksbot.ai/platforms/macos), [iOS](https://docs.seksbot.ai/platforms/ios), [Android](https://docs.seksbot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.seksbot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.seksbot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.seksbot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.seksbot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.seksbot.ai/gateway/pairing)
- [Remote gateway README](https://docs.seksbot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.seksbot.ai/web/control-ui)
- [Dashboard](https://docs.seksbot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.seksbot.ai/gateway/health)
- [Gateway lock](https://docs.seksbot.ai/gateway/gateway-lock)
- [Background process](https://docs.seksbot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.seksbot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.seksbot.ai/logging)

## Deep dives

- [Agent loop](https://docs.seksbot.ai/concepts/agent-loop)
- [Presence](https://docs.seksbot.ai/concepts/presence)
- [TypeBox schemas](https://docs.seksbot.ai/concepts/typebox)
- [RPC adapters](https://docs.seksbot.ai/reference/rpc)
- [Queue](https://docs.seksbot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.seksbot.ai/tools/skills-config)
- [Default AGENTS](https://docs.seksbot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.seksbot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.seksbot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.seksbot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.seksbot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.seksbot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.seksbot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.seksbot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.seksbot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.seksbot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.seksbot.ai/platforms/ios)
- [Android node](https://docs.seksbot.ai/platforms/android)
- [Windows (WSL2)](https://docs.seksbot.ai/platforms/windows)
- [Linux app](https://docs.seksbot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.seksbot.ai/gmail-pubsub](https://docs.seksbot.ai/automation/gmail-pubsub)

## Molty

seksbot was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [seksbot.ai](https://seksbot.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@seksbot](https://x.com/seksbot)
